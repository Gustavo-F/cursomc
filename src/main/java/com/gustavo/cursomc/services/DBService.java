...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
		...
		cat1.getProdutos().addAll(
			Arrays.asList(
				p1, p2, p3,p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23,
				p24, p25, p26, p27, p28, p29, p30, p31, p32, p34, p35, p36, p37, p38,
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "gugugatao.ferreira4@gmail.com", pe.encode("123"), "36378912377", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "gustavo.fs12@aluno.ifsc.edu.br", pe.encode("123"), "57569626036", TipoCliente.PESSOAFISICA);
		cli2.getTelefones().addAll(Arrays.asList("949959544", "587499544"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2016", null, "Centro", "89466282", cli2, c2);
